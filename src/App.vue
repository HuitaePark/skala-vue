...
const navGroups = [
  {
    ...
    description: 'PDF의 18개 Code Challenge를 주제와 페이지별로 나눴습니다. 작은 실습으로 핵심 문법을 직접 바꿔보세요.',
    sections: [
      {
        title: '기초 문법',
        items: [
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            meta: 'Default · Named · Scoped',
            to: '/components/slot',
            routeNames: ['components-slot'],
          },
          ...
          {
            label: 'UI Library · 회원가입',
            meta: '246쪽 · Form',
            to: '/ui-library',
            routeNames: ['ui-library-form'],
          },
          {
            label: 'UI Library · 상품',
            meta: '247쪽 · 수량 · 평점',
            to: '/ui-library/product',
            routeNames: ['ui-library-product'],
          },
          {
            label: 'UI Library · 피드백',
            meta: '248쪽 · Progress · Message Box',
            to: '/ui-library/progress',
            routeNames: ['ui-library-progress'],
          },
          {
            label: 'Vite · ESLint',
            meta: '270쪽 · lint 규칙',
            to: '/vite',
            routeNames: ['vite-eslint'],
          },
          {
            label: 'Vite · Prettier',
            meta: '271쪽 · format',
            to: '/vite/prettier',
            routeNames: ['vite-prettier'],
          },
          {
            label: 'Vite · 환경변수',
            meta: '272쪽 · mode · env',
